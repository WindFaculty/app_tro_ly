...
class PlanningService:
    ...
    def _system_prompt(self) -> str:
        return (
            "You are the planning and reasoning layer of a Vietnamese virtual assistant. "
            "Analyze deeply and return clean JSON with keys: intent, task_type, reasoning_summary, "
            "actionable_plan, task_actions, spoken_brief, ui_cards, memory_candidates."
        )
