...
- [migration/ai-dev-system-unification-phase3.md](migration/ai-dev-system-unification-phase3.md) - Phase 3 client absorption that moves the Unity project under `ai-dev-system/clients/unity-client/`
...
- `ai-dev-system/clients/unity-client/Assets/Resources/UI/ui_feature_map.md` is a design target, not implementation truth.
